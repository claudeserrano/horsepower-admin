		...
		<center>
            ...
            {{ csrf_field() }}
    	    	...
    	    	<div class="col-lg-12 panel panel-default">
    	    		...
    	    		<div class="panel-body">
    	    			...
    	    			<div class="col-lg-3">
    	    			    ...
    	    			    @if($errors->has('cell'))
    	    			        <p class="red">Please input your cellphone number</p>
    	    			    @endif
    	    			</div>
                        ...
                        <div class="col-lg-9">
                            {!! Form::text('company_address', '4101 1st Avenue, Brooklyn, NJ 11232',
                                ['class' => 'form-control',
                                 'readonly' => true
                                ]) 
                            !!}
                    ...
                    <div class="panel-body">
                        <div class="col-lg-12" style="padding-bottom: 15px">
                            <p><b>Share Partition (%)</b> lets you specify a specify percentage for each beneficiary. If you don't specify a share percentage, it will split evenly among all beneficiaries. <br><br>
                                ...
                                <br>If share percentage is specified for any secondary beneficiaries, then the total share percentage must add up to 100% for all secondary beneficiaries.
                                <br>There must be at least one primary beneficiary.
                            </p>
                        ...
                        <div class="col-lg-12" id="beneficiaries">
                            <div id="'+b_index+'" class="panel panel-default">
                                <div class="panel-body">
                                    <div class="col-lg-12" style="padding-bottom:20px">
                                        <h4>
                                    ...
                                    <div class="col-lg-12"> 
                                        ...
                                        <div class="col-lg-6"> 
                                            <input class="form-control" name="primary_name" type="text" value=""> 
                                        </div>
                                        <div class="col-lg-12"></div>
                                        <div class="col-lg-2"> 
                                            <h4>Relationship</h4> 
                                        ...
                                        <div class="col-lg-4"> 
                                            <input class="form-control" name="primary_relationship" type="text" value=""> 
                                        </div>
                                        <div class="col-lg-2"> 
                                            <h4>Share (%)</h4> 
                                        </div>
                ...
                <div class="col-lg-12 panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-12">
                            <textarea class="form-control" readonly name="notes" rows="5" disabled>You have a right to be a nonmember of USWU, and nonmembers have the right to: 
